...
# 프로젝트 개요 
- 본 프로젝트는 C 라이브러리를 코어로 두고, 이를 Java(Spring)와 Python에서 각각 로드하여 사용하는 Polyglot 아키텍처 기반의 채팅 시스템입니다. 네트워크 프로토콜의 설계, 메모리 관리, 멀티 쓰레드 환경, 명령어 큐 등의 아키텍처를 직접 구현하며 기본기를 다졌습니다.
